...
<?php define('BASEURL','http://localhost/PrograWeb2014/Tareas/11130587/EXAMEN'); ?>
    ...
    if(trim($HTTP_POST_VARS["usuario"]) != "" && trim($HTTP_POST_VARS["password"]) != "")
    {
        ...
        $result = mysql_query('SELECT pass, user FROM usuarios2 WHERE user=\''.$usuario.'\'');
        if($row = mysql_fetch_array($result)){
            if($row["pass"] == $password){
                ...
                echo '<a href="http://localhost/PrograWeb2014/Tareas/11130587/EXAMEN/views/11130587/index2.php">Index</a></p>';
                ...
                // location.href = "http://localhost/PrograWeb2014/Tareas/11130587/EXAMEN/models/index2.php";
                // </SCRIPT>
