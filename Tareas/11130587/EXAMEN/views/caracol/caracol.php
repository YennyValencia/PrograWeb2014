...
<form action="" method="POST">
	<label for="profundidad"></label>
		Profundidad:<input type="text" name="profundidad" id="profundidad">
	<label for="sube"></label>
		Sube:<input type="text" name="sube" id="sube">
	<label for="baja"></label>
		Baja:<input type="text" name="baja" id="baja">
	<label for="dias"></label>
		Dias:<input type="text" name="dias" id="dias">
